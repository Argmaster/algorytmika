...
# Regular expression is used to extract version from algorithms/__init__.py file
...
URL = "https://github.com/Argmaster/algorithms"
...
PROJECT_URLS = {
    "GitHub": "https://github.com/Argmaster/algorithms",
}
KEYWORDS = [
    "python-3",
    "python-3.7",
...
ENTRY_POINTS = {"console_scripts": ["algorithms=algorithms.__main__:main"]}
